...
void SystemClock_HSI_OUT84_Config(void) {
	...
	RCC_ClkInitStruct.ClockType = RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_SYSCLK
			| RCC_CLOCKTYPE_PCLK1 | RCC_CLOCKTYPE_PCLK2;
	RCC_ClkInitStruct.SYSCLKSource = RCC_SYSCLKSOURCE_PLLCLK;
	RCC_ClkInitStruct.AHBCLKDivider = RCC_SYSCLK_DIV1;  // 84/1=84 (Max 84 MHz on F401)
	RCC_ClkInitStruct.APB1CLKDivider = RCC_HCLK_DIV2;	// 84/2=42 (Max 42 MHz on F401)
	RCC_ClkInitStruct.APB2CLKDivider = RCC_HCLK_DIV1;	// 84/1=84 (Max 84 MHz on F401)
...
void SystemClock_HSE25_OUT96_Config(void) {
	...
	// For 411 we can use N=384, P=4, Q=8, this gives 96 MHz clock (Max 100)
	// AHB=APB2 = 96 (max 100) AHP1 = 48 (max 50)
	RCC_OscInitStruct.OscillatorType = RCC_OSCILLATORTYPE_HSE;
	RCC_OscInitStruct.HSEState = RCC_HSE_ON;
	RCC_OscInitStruct.PLL.PLLState = RCC_PLL_ON;
	RCC_OscInitStruct.PLL.PLLSource = RCC_PLLSOURCE_HSE;
	...
	RCC_ClkInitStruct.ClockType = RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_SYSCLK
			| RCC_CLOCKTYPE_PCLK1 | RCC_CLOCKTYPE_PCLK2;
	RCC_ClkInitStruct.SYSCLKSource = RCC_SYSCLKSOURCE_PLLCLK;
	RCC_ClkInitStruct.AHBCLKDivider = RCC_SYSCLK_DIV1;  // 96/1=96 (Max 100 MHz on F411)
	RCC_ClkInitStruct.APB1CLKDivider = RCC_HCLK_DIV2;	// 96/2=48 (Max 50 MHz on F411)
	RCC_ClkInitStruct.APB2CLKDivider = RCC_HCLK_DIV1;	// 96/1=96 (Max 100 MHz on F411)
